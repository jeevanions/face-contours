package com.google.codelab.mlkit.preference;/*
...
public class SettingsActivity extends AppCompatActivity {
  ...
  public enum LaunchSource {
    ...
    private final Class<? extends PreferenceFragmentCompat> prefFragmentClass;

    LaunchSource(int titleResId, Class<? extends PreferenceFragmentCompat> prefFragmentClass) {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    try {
      // Using getSupportFragmentManager() instead of getFragmentManager()
